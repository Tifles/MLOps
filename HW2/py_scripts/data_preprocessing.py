...
os.makedirs('./HW2/train', exist_ok=True)
os.makedirs('./HW2/test', exist_ok=True)

# Загружаем данные в датафрэйм
df = pd.read_csv('HW2/data/train.csv', delimiter = ',')
...
df_x_train_prep.to_csv(f'./HW2/train/x_train.csv', index=False)
df_x_val_prep.to_csv(f'./HW2/test/x_val.csv', index=False)
y_train.to_csv('./HW2/train/y_train.csv', index=False)
y_val.to_csv('./HW2/test/y_test.csv', index=False)